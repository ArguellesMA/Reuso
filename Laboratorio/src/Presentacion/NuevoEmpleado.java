...
public class NuevoEmpleado extends javax.swing.JFrame {
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if(txtidempleado.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta id empleado", "error", JOptionPane.ERROR_MESSAGE);
            ...
            JOptionPane.showMessageDialog(null, "Falta apellido materno", "error", JOptionPane.ERROR_MESSAGE);
        }else if(txtapellidop.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta apellido paterno", "error", JOptionPane.ERROR_MESSAGE);
        }else if(txtavenida.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta avenido", "error", JOptionPane.ERROR_MESSAGE);
        }else if(txtcalle.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta calle", "error", JOptionPane.ERROR_MESSAGE);
        }else if(txtcelular.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta celular", "error", JOptionPane.ERROR_MESSAGE);
        }else if(txtedad.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta edad", "error", JOptionPane.ERROR_MESSAGE);
        }else if(txtncasa.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta no de casa", "error", JOptionPane.ERROR_MESSAGE);
        }else if(txtcorreo.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Falta correo", "error", JOptionPane.ERROR_MESSAGE);
        }
        ...
        Negocios.Reglas sql=new Negocios.Reglas();
        sql.prueva(txtedad);
    ...
    private void txtapellidopKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtapellidopKeyTyped
        // TODO add your handling code here:
        int caracteres=20;
        if (txtapellidop.getText().length()>=caracteres)
        {
            evt.consume();
